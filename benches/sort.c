...
void bench_qsort(struct bench_context * const ctx)
{
    bench_sort(ctx, CSTL_SORT_ALGORITHM_QUICK);
}

void bench_qsort_r(struct bench_context * const ctx)
{
    bench_sort(ctx, CSTL_SORT_ALGORITHM_QUICK_R);
}

void bench_qsort_m(struct bench_context * const ctx)
{
    bench_sort(ctx, CSTL_SORT_ALGORITHM_QUICK_M);
}

void bench_hsort(struct bench_context * const ctx)
{
    bench_sort(ctx, CSTL_SORT_ALGORITHM_HEAP);
}
